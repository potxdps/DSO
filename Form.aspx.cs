...
"<countyEmail>" + countyEmail.Text + "</countyEmail>" +
"<ddcEmail>" + ddcEmail.Text + "</ddcEmail>" +
...
if (updateBubbleDataId != 0)
{
    ...
    bubbleDataId = api.AddData(creds(webeocIncident.SelectedValue), boardName, "Bubble Input (DO NOT ASSIGN)", "<data><updated>No</updated><jurisdictionType>" + radioJurisdictionType + "</jurisdictionType><county>" + county.SelectedItem.Text + "</county><city>" + cities + "</city></data>");
        ...
        public void sendEmail(string to, string subject, string body)
        {
            ...
            if (countyEmail.Text != "") { msg.CC.Add(countyEmail.Text); };
            if (ddcEmail.Text != "") { msg.CC.Add(ddcEmail.Text); };
            msg.Subject = subject;
            ...
            smtp.Credentials = new System.Net.NetworkCredential("postmaster@rs17820.mailgun.org", "3o8y30law8u2");
