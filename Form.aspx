  ...
  color:red;
    ...
    <script type="text/javascript">
        ...
        function finalEmailCheck() {
            ...
            checkEmail(document.getElementById('additionalEmails').value.split(','));
...
<br />
  ...
  <h3><span class="label label-default">  Residential Losses - Primary Residence Only</span></h3>
    ...
    <tr>
      ...
      <td> <div class="form-group form-inline"> <asp:TextBox ID="sfhCovByInsurance" placeholder="0" CssClass="form-control input-sm" runat="server"></asp:TextBox></div></td>
    </tr>
    <tr>
      ...
      <td> <div class="form-group form-inline"><asp:TextBox ID="mhCovByInsurance" placeholder="0" CssClass="form-control input-sm" runat="server"></asp:TextBox></div></td>
    </tr>
<tr>
      ...
      <td><div class="form-group form-inline"> <asp:TextBox ID="mfuCovByInsurance" placeholder="0" CssClass="form-control input-sm" runat="server"></asp:TextBox></div></td>
    </tr>
<tr>
      <td>Totals</td>
      ...
      <td> <div class="form-group form-inline"><asp:TextBox ID="totalsCovByInsurance" placeholder="0" CssClass="form-control input-sm" runat="server"></asp:TextBox></div></td>
    </tr>
</table>
...
<div class="form-group form-inline required">
    ...
    <div class="form-group form-inline required">
      <label class="control-label" for="submitterEmail">Email:</label>
       <asp:TextBox ID="submitterEmail" CssClass="form-control input-sm" runat="server" ></asp:TextBox>
             ...
             <div id="countyEmailSection" class="form-group form-inline">
 ...
 <div class="form-group form-inline">
      ...
      <label class="control-label" for="notes">Audit:</label>
        ...
        <asp:Button ID="saveCmd" runat="server" Text="Submit" OnClick="saveCmd_Click" />
        <asp:Button ID="cancelBttn" runat="server" Text="Cancel" OnClick="cancelBttn_Click" />
    </form>
</body>
</html>
