    ...
    if($(a).val() != "" && $(b).val() === "") {
        ...
        function start() {
            ...
            $("#saveCmd").on("click", function () { 
                submit();
                /*added 10/04/16, will this work the same?*/
                if($("#repairCost01").val() !== ""){
            validatingCatSelectOptionIfEstimatedIsNotEmpty("#repairCost01", "#cat01", "#cat01");
          }
          if($("#cat01").val() !== "" &amp;&amp; $("#repairCost01").val() == "" ){
            alert("Deselect this value if this entry is not needed. Failure to do so, with result in a false N/A (Anticipated Insurance Error).");
            $("#cat01").focus().select();
            return false;
          }
          if($("#repairCost02").val() !== ""){
          ...
          if($("#cat15").val() !== "" &amp;&amp; $("#repairCost15").val() == "" ){
            ...
            if ($("#jurisdictionType1").is(":checked") || $("#jurisdictionType2").is(":checked")) {
                ...
                //will this launch on update? the webeoc form has a dataid if statement 
                //if ('<xsl:value-of select="/data/@dataid"/>'!=0){from here - to here City copy below}
...
<body>
    ...
    <div class="form-group required form-inline">
      <label class="control-label" for="jurisdictionType">Jurisdiction Type:</label><!--added jTypeCLASS below10/04/16, will this work the same?-->
        <asp:RadioButton ID="jurisdictionType1" CssClass="form-control input-sm jTypeCLASS" GroupName="jurisdictionType" runat="server" Text="City" />
        <asp:RadioButton ID="jurisdictionType2" CssClass="form-control input-sm jTypeCLASS" GroupName="jurisdictionType" runat="server" Text="County" />
    </div>
    <div class="form-group required form-inline">
   ...
   <div class="form-group required form-inline">
    ...
    <div class="form-group form-inline" style="display:none">
                    <asp:TextBox ID="cityTmp" name="cityTmp" runat="server" CssClass="form-control" Rows="5" Columns="70" TextMode="MultiLine">
                  </asp:TextBox></div>
